...
*/
    ...
    function sendMessage(messageText) {
        ...
        */
        $('<div class="message loading new"><figure class="avatar"><img src="../cybergames/images/hackerprofile.jpg" /></figure><span></span></div>').appendTo($('.mCSB_container'));
        updateScrollbar();

        setTimeout(function() {
            $('.message.loading').remove();
            $('<div class="message new"><figure class="avatar"><img src="../cybergames/images/hackerprofile.jpg" /></figure>' + messageText + '</div>').appendTo($('.mCSB_container')).addClass('new');
            setDate();
            updateScrollbar();
